...
''' <summary>
''' Provides an implementation of a <c>Java</c> syntax language that can perform automatic outlining.
''' </summary>
Public Class JavaDynamicSyntaxLanguage
	...
	''' <summary>
	''' Initializes a new instance of the <c>JavaDynamicSyntaxLanguage</c> class. 
	''' </summary>
	...
	Public Overrides Sub GetTokenOutliningAction(ByVal tokenStream As TokenStream, ByRef outliningKey As String, ByRef tokenAction As OutliningNodeAction)
		...
		Select Case token.Key
			...
			Case "JavaDocCommentStartToken"
				outliningKey = "JavaDocComment"
				tokenAction = OutliningNodeAction.Start
			Case "JavaDocCommentEndToken"
				outliningKey = "JavaDocComment"
				tokenAction = OutliningNodeAction.End
...
End Class 'JavaDynamicSyntaxLanguage
