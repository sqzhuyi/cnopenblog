<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Reply.aspx.cs" Inherits="Groups_Reply" Title="我回复的话题 - cnOpenBlog" %>
...
<div id="rightdiv" class="right">
    ...
    <p><a class="curr" href="/groups/reply.aspx">我回复的话题</a></p>
    </div>
    <script type="text/javascript">
    if(isIE) document.write('<img src="/images/box/bl.gif" alt="" style="float:left;margin-top:-4px;" /><img src="/images/box/br.gif" alt="" style="float:right;margin-top:-4px;" />');
    </script>
