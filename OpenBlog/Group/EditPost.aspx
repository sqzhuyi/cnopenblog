<%@ Page Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="EditPost.aspx.cs" Inherits="Group_EditPost" Title="修改帖子 - cnOpenBlog" %>
...
.btna { float:left; display:block; width:115px; height:22px; margin-right:20px; background:url(/images/r-btn.gif) no-repeat; text-align:center; padding-top:10px; font-size:13px; font-weight:bold; color:#2d6f92; text-decoration:none;}
...
<p><a href="/">首页</a> &gt;&gt; <a href="/group/?all">群组</a> &gt;&gt; <a href="/group/<%=groupID.ToString()+DLL.Settings.Ext %>"><%=DLL.Tools.HtmlEncode(groupName) %></a> &gt;&gt; 编辑帖子</p>
<br />
...
<a class="btna" href="javascript:void(0);" onclick="javascript:publish(this);return false;">发表帖子</a><a class="btna" href="javascript:void(0);" onclick="javascript:cancel();return false;">取 消</a>
</div>
<div class="clear"></div>
</div>
<div class="clear"></div>
...
<input id="hd_title" type="hidden" value="<%=topicTitle %>" />
<textarea id="hd_content" cols="100" rows="1" style="visibility:hidden;">
<%=topicContent %>
</textarea>
