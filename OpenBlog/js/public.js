var baseURL = "http://www.cnopenblog.com/";
var ext = ".htm";
...
function els(e, tag)
{
    var arr = null;
    if(tag){
        if(typeof e=="string") arr = el(e).getElementsByTagName(tag);
...
var isIE = navigator.userAgent.split('(')[1].indexOf("MSIE")!=-1;
function getVersion()
{
    var agent = navigator.userAgent.split('(')[1];
    var ver = 0;
    if(agent.indexOf("MSIE 6")!=-1) ver = 6;
    else if(agent.indexOf("MSIE 7")!=-1) ver = 7;
    else if(agent.indexOf("MSIE 8")!=-1) ver = 8;
    else if(agent.indexOf("Firefox")!=-1) ver = 10;
